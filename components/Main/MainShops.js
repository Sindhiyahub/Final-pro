...
const APIKEY = '65b71ccedbmsh8b1fd8dc80de7d4p16a315jsn6bd68c02ec85';
...
const MainShops = () => {
  ...
  const productListOne = () => {
    productListHandler("Women");
  };

  const productListTwo = () => {
    productListHandler("Men");
  };

  const productListThree = () => {
    productListHandler("Family");
  };

  const productListFour = () => {
    productListHandler("Footwear");
  };
